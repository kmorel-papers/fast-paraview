...
%DIF ADD original-submission/../Fast_ParaView.tex   Tue Mar  5 15:49:12 2024
...
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{pics/Ast5.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{Final_Pics/Larsen_the3.png}
...
but reducing the number of colors lowers the discriminative power of the map. Consequently, there is no such thing as the perfect color map. Our default colormap needs to be a jack of all trades even if }\DIFdelend \DIFaddbegin 
...
illustrates the discriminatory at points across the colormap. The abbreviations, left to right: RA - }\huewheel\DIFaddFL{; CW - }\coolwarm\DIFaddFL{; ECW - }\extendedcoolwarm\DIFaddFL{; BOD = }\blueorange\DIFaddFL{; VI - }\colormap{Viridis}\DIFaddFL{; GP - }\colormap{Grayscale}\DIFaddFL{; GR - }\colormap{Green-Red}\DIFaddFL{. }}
\label{Ware}
\end{figure}

\DIFadd{Ware tested the internal contrast levels of commonly used colormaps.
...
\caption{
  \DIFaddFL{These visualizations are slices through magnetosphere around Ganymede, illustrating three primary types of contrast applied to data.
...
\DIFaddend The \DIFaddbegin \DIFadd{most common request we receive from scientists is higher feature resolution, a property driven by the internal contrast levels within the colormap.
...
%DIF > \begin{figure}[htb]
%DIF > \centering
%DIF > \includegraphics[width=\columnwidth]{pics/Ocean2.png}
...
%DIF > Figure~\ref{Ware} details the impact on the discriminatory power.
...
\begin{table}[t]
  ...
  \begin{tabular}{r@{\quad~( }r@{, }r@{, }r@{ )\quad~( }r@{, }r@{, }r@{ )\quad~}c}
    ...
    \midrule
    \DIFaddFL{0.00 }&  \DIFaddFL{14 }&  \DIFaddFL{14 }& \DIFaddFL{120 }&   \DIFaddFL{14.3 }&  \DIFaddFL{39.5 }& \DIFaddFL{-57.3 }& \colordemo{fast0} \\
    \DIFaddFL{0.17 }&  \DIFaddFL{62 }& \DIFaddFL{117 }& \DIFaddFL{207 }&   \DIFaddFL{49.9 }&  \DIFaddFL{11.4 }& \DIFaddFL{-51.5 }& \colordemo{fast1} \\
    \DIFaddFL{0.30 }&  \DIFaddFL{91 }& \DIFaddFL{190 }& \DIFaddFL{243 }&   \DIFaddFL{73.2 }& \DIFaddFL{-13.3 }& \DIFaddFL{-35.1 }& \colordemo{fast2} \\
    \DIFaddFL{0.43 }& \DIFaddFL{175 }& \DIFaddFL{237 }& \DIFaddFL{234 }&   \DIFaddFL{89.7 }& \DIFaddFL{-19.9 }&  \DIFaddFL{-4.8 }& \colordemo{fast3} \\
    \DIFaddFL{0.50 }& \DIFaddFL{229 }& \DIFaddFL{241 }& \DIFaddFL{196 }&   \DIFaddFL{93.2 }& \DIFaddFL{-11.3 }&  \DIFaddFL{20.4 }& \colordemo{fast4} \\
    \DIFaddFL{0.59 }& \DIFaddFL{244 }& \DIFaddFL{213 }& \DIFaddFL{130 }&   \DIFaddFL{86.1 }&   \DIFaddFL{0.4 }&  \DIFaddFL{44.8 }& \colordemo{fast5} \\
    \DIFaddFL{0.71 }& \DIFaddFL{237 }& \DIFaddFL{158 }&  \DIFaddFL{80 }&   \DIFaddFL{71.6 }&  \DIFaddFL{21.9 }&  \DIFaddFL{51.5 }& \colordemo{fast6} \\
    \DIFaddFL{0.85 }& \DIFaddFL{204 }&  \DIFaddFL{90 }&  \DIFaddFL{41 }&   \DIFaddFL{52.1 }&  \DIFaddFL{42.6 }&  \DIFaddFL{48.5 }& \colordemo{fast7} \\
    \DIFaddFL{1.00 }& \DIFaddFL{150 }&  \DIFaddFL{20 }&  \DIFaddFL{30 }&   \DIFaddFL{32.0 }&  \DIFaddFL{51.4 }&  \DIFaddFL{30.6 }& \colordemo{fast8} \\
    \bottomrule
  \end{tabular}
\end{table}
...
%DIF > \includegraphics[width=\linewidth]{pics/Larsen2.png}

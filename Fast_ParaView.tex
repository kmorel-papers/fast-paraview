...
\caption{
  These visualizations are slices through magnetosphere around Ganymede, illustrating the Artistic Color Contrast Theory applied to data.
  Left to right:  value or luminance contrast; saturation contrast; hue contrast; and a combination of hue, saturation, luminance, analogous contrast and cool - warm contrast.
}
\label{contrast}
\end{figure*}
...
The first three are contrast of hue, saturation, and luminance, which are familiar as they align with parameters of HSL and other color spaces.
Two more are the cool-warm contrast and complimentary contrast, both of which involve colors on opposite sides of the color wheel.
The remaining two are simultaneous contrast at play in the \huewheel colormap and contrast of extension, which speaks to balance of the area covered by specific hues.

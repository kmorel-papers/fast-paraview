...
\caption{This chart by Ware et al. \cite{Ware2017} illustrates the discriminatory at points across the colormap. The abbreviations, left to right: RA - \huewheel; CW - \coolwarm; ECW - \colormap{Extended Cool Warm}; BOD = \blueorange; VI - \textit{Viridis}; GP - \textit{Grayscale}; GR - \textit{Green-Red}. }
\label{Ware}
\end{figure}

...
\paper{8}
\jmonth{July/August}
\jname{IEEE Computer Graphics and Applications}
\pubyear{2024}
...
\markboth{VISUALIZATION VIEWPOINTS}{VISUALIZATION VIEWPOINTS}
...
%, shown in Figure~\ref{fig:designs}. 
...
%range as shown in Figure~\ref{fig:ware}. \km{The figure shows no isolumant maps}.
...
Figure~\ref{fig:contrast} illustrates the impact of increasing the ranges of luminance, saturation and hue. All of the examples begin with the \coolwarm colormap as a base.
...
Each increase in contrast type demonstrates greater detail than the original \coolwarm it comes from.
...
%\begin{figure}[htb]
%\centering
%\includegraphics[width=\columnwidth]{Ocean2}
...
%Figure~\ref{fig:ware} details the impact on the discriminatory power.
...
\begin{table}[t]
  ...
  \begin{tabular}{r@{\quad~( }r@{, }r@{, }r@{ )\quad~}c@{}c}
    ...
    \midrule
    1.00 & 150 &  20 &  30 & \colordemo{fast8} & \multirow{9}{.26 in}{\includegraphics{fast-colorbar-vertical}} \\

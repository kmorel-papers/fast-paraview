...
\\
I rearranged the figure but didn't fix the caption. That is why they are off.
...
\fix{ I will move the text about specific needs down so that it draws on the Matriz figure, the reason I made that figure. This igure was made to illustrate Hue, saturation and value in a visual context. }
